...
func (s *Sanitizer) getRedactionLabel(patternName, patternType string) string {
	...
	labels := map[string]string{
		...
		patterns.PatternAWSAccessKeyID:              "[REDACTED_AWS_ACCESS_KEY_ID]",
		patterns.PatternAWSSecretAccessKey:          "[REDACTED_AWS_SECRET_ACCESS_KEY]",
		patterns.PatternAWSSessionToken:             "[REDACTED_AWS_SESSION_TOKEN]",
		patterns.PatternGenericSecretAssignment:     "[REDACTED_CREDENTIAL]",
		patterns.PatternGenericAPIKeyAssignment:     "[REDACTED_CREDENTIAL]",
		patterns.PatternGenericTokenAssignment:      "[REDACTED_CREDENTIAL]",
		patterns.PatternGenericPrivateKeyAssignment: "[REDACTED_CREDENTIAL]",
